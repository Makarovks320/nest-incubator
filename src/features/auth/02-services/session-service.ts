...
import { IpType, Session } from '../03-domain/session-model';
...
export class SessionService {
    ...
    async addSession(ip: IpType, deviceId: string, deviceName: string, refreshToken: string): Promise<Session | null> {
